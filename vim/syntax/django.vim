...
" Last Updated: 2017 Sep 17 12:32:01 PM CDT
" Updated by Sergey Golitsynskiy (color switch)
...
if version >= 508 || !exists("did_django_syn_inits")
  ...
  " updated on 9/17/17: I prefer blue
  " HiLink djangoTagBlock PreProc
  " HiLink djangoVarBlock PreProc
  " HiLink djangoFilter Identifier
  
  HiLink djangoTagBlock Identifier
  HiLink djangoVarBlock Identifier
  HiLink djangoStatement Statement
  HiLink djangoFilter PreProc
